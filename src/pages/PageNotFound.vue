...
<template>
  <div class="max-w-6xl bg-gray-800 grow w-full" style="margin: 0 auto">
    <div class=" px-3 py-2" style="margin: 0 auto">
     
      <main
        aria-labelledby="pageTitle"
        class="flex items-center justify-center h-screen dark:text-light"
      >
          ...
          <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
            ...
            <div class="space-y-2">
              <h1 id="pageTitle" class="flex items-center space-x-2">
                <svg
                  aria-hidden="true"
                  class="w-6 h-6 text-red-500 dark:text-apple"
              ...
              <p class="text-base font-normal text-gray-600 dark:text-gray-300">
                You may return to
                <a href="https://kamona-wd.github.io/kwd-dashboard/" class="text-blue-600 hover:underline dark:text-indigo-500">home page</a> or try
